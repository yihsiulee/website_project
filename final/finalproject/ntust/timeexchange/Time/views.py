	...
	if request.user.is_authenticated:
			if request.method == 'POST':
				...
				if goods_form.is_valid():
					...
					member.seller_set.create(coursename=coursename,coursedescription=coursedescription,coursevalue=coursevalue,contact=contact)
...
def transaction(request):
	if request.user.is_authenticated:
		...
		HttpResponseRedirect('/timeexchange/login/')
